...
export const portfolioAPI = {
  ...
  transaction: (data: any) => api.post('/api/portfolio/transaction', data),
...
export const watchlistAPI = {
  ...
  addAlert: (data: any) => api.post('/api/watchlist/alert', data),
};
